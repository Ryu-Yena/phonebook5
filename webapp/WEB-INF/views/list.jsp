	...
	<c:forEach items="${requestScope.pList }" var="personVo">
		<table border="1">
			...
			<tr>
				...
				<td><a href="${pageContext.request.contextPath}/phone/delete?${personVo.personId}">[삭제]</a>
				<a href="${pageContext.request.contextPath}/phone/delete2?personId=${personVo.personId}">[삭제2]</a></td>
		</table>
		<br>
	</c:forEach>
